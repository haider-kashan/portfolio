...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Show Achievements & Awards Section",
      type: "boolean",
      description: "Toggle to show or hide the Achievements and Awards section on the portfolio.",
      initialValue: false,
    }),
    defineField({
      name: "showExperience",
      ...
      type: "boolean",
      initialValue: true, // Default to true since these are core sections
    }),
    defineField({
      name: "showEducation",
    ...
    // Bonus: Might as well add Projects just in case
    defineField({
      name: "showProjects",
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          type: "text",
          rows: 2,
          description: "Short bio or tagline for the footer.",
        }),
        defineField({
          name: "copyrightText",
