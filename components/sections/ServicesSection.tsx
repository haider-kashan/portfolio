            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {featured.map((service) => (
                <article
                  ...
                  className="group relative flex flex-col p-6 rounded-3xl bg-card/60 backdrop-blur-xl border border-white/10 dark:border-white/5 shadow-2xl hover:shadow-[0_0_40px_-10px_var(--color-primary)]/20 transition-all duration-500 overflow-hidden"
                  itemScope
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                      ...
                      {service.icon && (
                        <div className="relative w-12 h-12 p-2.5 bg-background/50 backdrop-blur-md rounded-xl border border-white/10 shadow-lg group-hover:scale-105 transition-transform duration-500">
                          <Image
                            ...
                            alt="" // Decorative icon, empty alt is correct
                            fill
                    ...
                    {service.features && service.features.length > 0 && (
                      <div className="mb-6 p-4 bg-background/40 rounded-xl border border-white/5">
                        ...
                        <ul className="space-y-2">
                          {/* FIXED: Removed idx, using feature string as key */}
                    ...
                    {service.technologies && service.technologies.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mt-auto">
                        {/* FIXED: Removed idx, using tech.name as key */}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {regular.map((service) => (
                <article
                  key={service.slug?.current || service.title}
                  className="group relative flex flex-col p-5 rounded-2xl border border-border/50 bg-background/50 hover:bg-card/60 hover:border-[var(--color-primary)]/30 hover:shadow-lg transition-all duration-300"
                  itemScope
                  itemType="http://schema.org/Service"
                >
