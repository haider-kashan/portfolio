...
export async function ContactSection() {
  ...
  return (
    <section 
      ...
      className="py-12 md:py-24 px-6 pb-20 md:pb-40 relative overflow-hidden bg-background"
    >
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="@container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            {/* LEFT COLUMN: Contact Info - Slide from Left */}
            <ScrollAnimation variant="slideFromLeft" delay={0.4}>
                <address 
            ...
            <ScrollAnimation variant="slideFromRight" delay={0.5}>
