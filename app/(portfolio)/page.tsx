...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const ogImageUrl = openGraphImage ? urlFor(openGraphImage).width(1200).height(630).url() : undefined;
...
export default async function Home() {
    ...
    const ogImageSchemaUrl = openGraphImage 
        ? urlFor(openGraphImage).width(800).height(800).url() 
        : undefined;
